...
public class Maia.TestCassowary : Maia.TestCase
{
    ...
    test_example ()
    {
        try
        {
            ...
            // twice times y
            // [x >= 2*y]
            solver.add_constraint (new Cassowary.LinearInequality.with_variable_expression (x,
                                                                                            Cassowary.Operator.GEQ,
                                                                                            Cassowary.var_times_constant (y, 2)));
            ...
            solver.add_constraint (new Cassowary.LinearEquation.with_variable_value (x, 20, Cassowary.Strength.weak));
            ...
            solver.add_constraint (new Cassowary.LinearInequality.with_expressions (Cassowary.var_plus_expr (x, new Cassowary.LinearExpression (y)),
                                                                                    Cassowary.Operator.LEQ,
                                                                                    new Cassowary.LinearExpression.from_constant (50)));
            ...
            Test.message (@"x == $(x.value)");
            Test.message (@"y == $(y.value)");
    ...
    test_grid ()
    {
        try
        {
            Cassowary.Box main = new Cassowary.Box ("main");

            Cassowary.Box item00 = new Cassowary.Box ("item00");
            Cassowary.Box item01 = new Cassowary.Box ("item01");
            Cassowary.Box item02 = new Cassowary.Box ("item02");
            Cassowary.Box item10 = new Cassowary.Box ("item10");
            ...
            main.add_box (item00, Cassowary.Box.Position.TOP | Cassowary.Box.Position.LEFT);
            main.add_box (item01);
