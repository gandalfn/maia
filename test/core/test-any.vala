...
public class Maia.TestAny : Maia.TestCase
{
    ...
    public class FooAny : Maia.Core.Any
    {
    ...
    set_up ()
    {
        Maia.Core.Any.delegate (typeof (FooAny), typeof (FooDelegate));
        Maia.Core.Any.delegate (typeof (FooAnyDual), typeof (FooDelegateDual));
    }

    public override void
    tear_down ()
    {
        Maia.Core.Any.undelegate (typeof (FooAny));
        Maia.Core.Any.undelegate (typeof (FooAnyDual));
    }
