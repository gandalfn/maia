...
namespace Xcb.Glx
{
	...
	public class VendorPrivateWithReplyReply {
		...
		public int data_1_length {
			[CCode (cname = "xcb_glx_vendor_private_with_reply_data_1_length")]
			get;
		}
		[CCode (array_length = false)]
		public unowned uint8[] data_1 {
			[CCode (cname = "xcb_glx_vendor_private_with_reply_data_1")]
			get;
		}
	...
	struct _FbconfigIterator
	{
		internal int rem;
		internal int index;
		internal unowned Fbconfig? data;
	}
	...
	public class PbufferClobberEvent : GenericEvent {
	...
	[CCode (cname = "uint8", cprefix =  "XCB_GLX_", has_type_id = false)]
