...
namespace Xcb
{
	...
	public class GraphicsExposureEvent : GenericEvent {
	...
	public class NoExposureEvent : GenericEvent {
		public Drawable drawable;
		public uint16 minor_opcode;
		public uint8 major_opcode;
	}
	...
	public class ResizeRequestEvent : GenericEvent {
		public Window window;
		public uint16 width;
		public uint16 height;
	}
	...
	public class SelectionClearEvent : GenericEvent {
		public Timestamp time;
		public Window owner;
	...
	public class SelectionRequestEvent : GenericEvent {
		public Timestamp time;
		public Window owner;
	...
	public class CirculateRequestEvent : GenericEvent {
		/**
		 * Either the restacked window or its parent, depending on whether
		 * `StructureNotify` or `SubstructureNotify` was selected.
		 */
