...
namespace Xcb.Render
{
	...
	public class QueryPictFormatsReply {
		...
		[CCode (array_length = false)]
		public unowned Pictscreen[] screens {
			[CCode (cname = "xcb_render_query_pict_formats_screens")]
			get;
		}
	...
	public struct Picture : uint32 {
		...
		[CCode (cname = "xcb_render_fill_rectangles", instance_pos = 1.2)]
	...
	public struct Pictdepth {
		...
		public int visuals_length {
			[CCode (cname = "xcb_render_pictdepth_visuals_length")]
			get;
		}
		[CCode (array_length = false)]
		public unowned Pictvisual[] visuals {
	...
	public struct Pictscreen {
		...
		public int depths_length {
			[CCode (cname = "xcb_render_pictscreen_depths_length")]
			get;
		}
		[CCode (array_length = false)]
		public unowned Pictdepth[] depths {
			[CCode (cname = "xcb_render_pictscreen_depths")]
			get;
		}
	}
