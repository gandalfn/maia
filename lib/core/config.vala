...
public errordomain Maia.Core.ConfigError
{
    SCHEMA,
    OPEN,
    LOADING,
 ...
 */
public class Maia.Core.Config : GLib.Object
{
    // properties
    ...
    public string filename {
        ...
        set {
            ...
            if (m_Filename != null)
            {
                try
                {
                    m_File = GLib.File.new_for_path (m_Filename);
     ...
     */
    public Config.load (string inFilename) throws ConfigError
    {
        ...
        try
        {
            if (!m_KeyFile.load_from_file (filename, GLib.KeyFileFlags.KEEP_COMMENTS))
            {
        ...
        switch (inEvent)
        {
            ...
            case GLib.FileMonitorEvent.CHANGED:
                ...
                try
                {
                    ...
                    {
                        Log.critical (GLib.Log.METHOD, Log.Category.CORE_CONFIG, "Error on loading %s", m_Filename);
                    }
                    else
                    {
                        updated ();
                    }
                    Log.debug (GLib.Log.METHOD, Log.Category.CORE_CONFIG, "%s changed or created reload settings", m_Filename);
                }
                catch (GLib.KeyFileError err)
                {
                    Log.critical (GLib.Log.METHOD, Log.Category.CORE_CONFIG, "Error on loading %s: %s", m_Filename, err.message);
                }
                catch (GLib.FileError err)
                {
                    Log.critical (GLib.Log.METHOD, Log.Category.CORE_CONFIG, "Error on loading %s: %s", m_Filename, err.message);
    ...
    save () throws ConfigError
    {
        if (m_Filename == null)
        {
            throw new ConfigError.SAVE ("No filename set !");
        }
        ...
        if (m_MonitorFile != null)
        {
            m_MonitorFile.changed.disconnect (on_config_file_changed);
        }
     ...
     * @param inSection section name
     * @param inKey key name
     * @param inDefaultValue default value if property is not found
     *
     * @return the boolean value associated to inKey under inSection else inDefault if property does not exist
     */
    public bool
    get_boolean_with_default (string inSection, string inKey, bool inDefaultValue)
    {
        try
        {
            return m_KeyFile.get_boolean (inSection, inKey);
     ...
     */
    public bool[]
    get_boolean_list_with_default (string inSection, string inKey, bool[] inDefaultValue)
    {
        try
        {
            return m_KeyFile.get_boolean_list (inSection, inKey);
     ...
     */
    public int
    get_integer_with_default (string inSection, string inKey, int inDefaultValue)
    {
        try
        {
            return m_KeyFile.get_integer (inSection, inKey);
     ...
     */
    public int[]
    get_integer_list_with_default (string inSection, string inKey, int[] inDefaultValue)
    {
        try
        {
            return m_KeyFile.get_integer_list (inSection, inKey);
     ...
     */
    public double
    get_double_with_default (string inSection, string inKey, double inDefaultValue)
    {
        try
        {
            return m_KeyFile.get_double (inSection, inKey);
     ...
     */
    public double[]
    get_double_list_with_default (string inSection, string inKey, double[] inDefaultValue)
    {
        try
        {
            return m_KeyFile.get_double_list (inSection, inKey);
     ...
     */
    public string
    get_string_with_default (string inSection, string inKey, string inDefaultValue)
    {
        try
        {
            return m_KeyFile.get_string (inSection, inKey);
     ...
     */
    public string[]
    get_string_list_with_default (string inSection, string inKey, string[] inDefaultValue)
    {
        try
        {
            return m_KeyFile.get_string_list (inSection, inKey);
