...
internal delegate bool Maia.Core.TimeoutFunc(void* inData);

internal class Maia.Core.TimeoutInterval : Object
{
    ...
    compare (Object inOther)
        requires (inOther is TimeoutInterval)
    {
        return (int)(m_Delay - ((TimeoutInterval)inOther).m_Delay);
    }
}
