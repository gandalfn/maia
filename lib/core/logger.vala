...
namespace Maia.Log
{
    ...
    public enum Category
    {
        ...
        CORE_COLLECTION    = 1 << 1,
        CORE_TIMELINE      = 1 << 2,
        CORE               = CORE_OBJECT | CORE_COLLECTION | CORE_TIMELINE,
        GRAPHIC_PARSING    = 1 << 3,
        GRAPHIC_DRAW       = 1 << 4,
        GRAPHIC_GEOMETRY   = 1 << 5,
        GRAPHIC            = GRAPHIC_DRAW | GRAPHIC_GEOMETRY | GRAPHIC_PARSING,
        MANIFEST_PARSING   = 1 << 6,
        MANIFEST_ATTRIBUTE = 1 << 7,
