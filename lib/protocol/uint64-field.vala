...
internal class Maia.Protocol.UInt64Field : Field
{
    // accessors
    ...
    // methods
    public UInt64Field (string inName, bool inRepeated, string? inDefault) throws ProtocolError
    {
    ...
    {
        Field field = new UInt64Field (name, repeated, null);
        field.m_Values = {};
    ...
    {
        return new GLib.Variant.uint64 ((uint64)m_Values[inIndex]);
    }
    ...
    {
        m_Values[inIndex] = inVariant.get_uint64 ();
    }
