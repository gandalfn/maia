...
internal class Maia.Protocol.DoubleField : Field
{
    // accessors
    ...
    // methods
    public DoubleField (string inName, bool inRepeated, string? inDefault)
    {
    ...
    {
        return new GLib.Variant.double ((double)m_Values[inIndex]);
    }
