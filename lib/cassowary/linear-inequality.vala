...
public class Maia.Cassowary.LinearInequality : LinearConstraint
{
    ...
    public LinearInequality.with_variables (Variable inVariable1, Operator inOperator, Variable inVariable2,
    ...
    public LinearInequality.with_variable_value (Variable inVariable, Operator inOperator, double inVal,
                                                 Strength inStrength = Strength.required, double inWeight = 1.0) throws Error
    {
