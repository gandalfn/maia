...
namespace Maia.Cassowary
{
    ...
    public static LinearExpression
    var_plus_expr (Variable inVariable, LinearExpression inExpression)
    {
        return (new LinearExpression (inVariable)).plus (inExpression);
    }

    public static LinearExpression
    expr_plus_var (LinearExpression inExpression, Variable inVariable)
    {
        return inExpression.plus (new LinearExpression(inVariable));
    }

    public static LinearExpression
    var_plus_constant (Variable inVariable, double inConstant)
    {
        return (new LinearExpression (inVariable)).plus (new LinearExpression.from_constant (inConstant));
    }

    public static LinearExpression
    constant_plus_variable (double inConstant, Variable inVariable)
    {
    ...
    public static LinearExpression
    expr_times_var (LinearExpression inExpression, Variable inVariable) throws Error
    {
        return inExpression.times (new LinearExpression (inVariable));
    }

    public static LinearExpression
    var_times_expr (Variable inVariable, LinearExpression inExpression) throws Error
    {
    ...
    public static LinearExpression
    constant_times_var (double inConstant, Variable inVariable) throws Error
    {
        return new LinearExpression (inVariable, inConstant);
    }

    public static LinearExpression
    var_times_constant (Variable inVariable, double inConstant) throws Error
    {
        return new LinearExpression (inVariable, inConstant);
    }
