...
ifelse(m4_index(`$2', `is_'),0, $2(), `ifelse(m4_index(`$2', `have_'),0, $2(), `ifelse(m4_index(`$2', `can_'),0, $2(), `ifelse(m4_index(`$2', `have_'),0, $2(), `ifelse(`$2', `visible', $2(), `ifelse(m4_index(`$2', `need_'),0, $2(), `ifelse(`$2', `proceed', $2(), get_$2())')')')')')')dnl
'dnl
)dnl
