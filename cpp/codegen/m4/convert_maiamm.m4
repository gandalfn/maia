...
_CONVERSION(`ChartDirection',`MaiaChartDirection',`(MaiaChartDirection)$3')
_CONVERSION(`MaiaChartDirection',`ChartDirection',`(ChartDirection)$3')

_CONVERSION(`ChartViewLegendPosition',`MaiaChartViewLegendPosition',`(MaiaChartViewLegendPosition)$3')
_CONVERSION(`MaiaChartViewLegendPosition',`ChartViewLegendPosition',`(ChartViewLegendPosition)$3')
...
_CONV_ENUM(Maia,WindowBorder)
_CONV_ENUM(Maia,ChartDirection)
_CONV_ENUM(Maia,ChartViewLegendPosition)
_CONV_ENUM(Maia,ChartViewFrame)
_CONV_ENUM(Maia,WindowType)
_CONV_ENUM(Maia,WindowPositionPolicy)
